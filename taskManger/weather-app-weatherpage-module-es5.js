(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["weather-app-weatherpage-module"], {
    ...
    function Oliy(module, __webpack_exports__, __webpack_require__) {
      ...
      var _login_auth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../login/auth.guard */
      "VQQV");
      /* harmony import */


      var _weather_app_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var routes = [{
        path: '',
        component: _weather_app_component__WEBPACK_IMPORTED_MODULE_5__["WeatherAppComponent"],
      ...
      WeatherModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: WeatherModule
      });
      WeatherModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        factory: function WeatherModule_Factory(t) {
          return new (t || WeatherModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_3__["AngularMaterialModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"]], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](WeatherModule, {
          declarations: [_weather_app_component__WEBPACK_IMPORTED_MODULE_5__["WeatherAppComponent"]],
          imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_3__["AngularMaterialModule"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"]],
    ...
    /***/
    function xtf1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "WeatherAppComponent", function () {
      ...
      var WeatherAppComponent = /*#__PURE__*/function () {
        function WeatherAppComponent() {
          var _this = this;

          _classCallCheck(this, WeatherAppComponent);

          this.location = false;
          this.key = 'fHiCJkw5hhbaDOtWwt4bA1eatm3nryBJ';

          this.getCity = function () {
            var city = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "giza";
        ...
        _createClass(WeatherAppComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.getCity('cairo').then(function (data) {
              console.log(data.EnglishName);
              _this2.cityName = data.EnglishName;
              return _this2.getWeather(data.Key);
            }).then(function (data) {
              _this2.cloudly = data.WeatherText;
              _this2.temp = data.Temperature.Metric.Value;
          ...
          value: function locationSubmitted(info) {
            var _this3 = this;

            console.log(info.value.location);
            var location = info.value.location.trim();
            this.getCity(location).then(function (data) {
              _this3.cityName = data.EnglishName;
              console.log(data);
              return _this3.getWeather(data.Key);
            }).then(function (data) {
              console.log(data);
            })["catch"](function (err) {
              console.log(err);
      ...
      WeatherAppComponent.ɵfac = function WeatherAppComponent_Factory(t) {
        return new (t || WeatherAppComponent)();
      };

      WeatherAppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: WeatherAppComponent,
        selectors: [["app-weather-app"]],
        decls: 61,
        vars: 8,
        consts: [[1, "container"], [1, "weather-side"], [1, "weather-gradient"], [1, "date-container"], [1, "date-dayname"], [1, "date-day"], ["data-feather", "map-pin", 1, "location-icon"], [1, "location"], [1, "weather-container"], ["data-feather", "sun", 1, "weather-icon"], [1, "weather-temp"], [1, "weather-desc"], [1, "info-side"], [1, "today-info-container"], [1, "today-info"], [1, "precipitation"], [1, "title"], [1, "value"], [1, "clear"], [1, "humidity"], [1, "wind"], [1, "week-container"], [1, "week-list"], [1, "active"], ["data-feather", "sun", 1, "day-icon"], [1, "day-name"], [1, "day-temp"], [1, "location-container"], [3, "ngSubmit"], ["info", "ngForm"], [1, "location-button", 2, "color", "black", 3, "type", "disabled"], ["data-feather", "map-pin"], [1, "weather", "input"], ["appearance", "outline", "appearance", "fill", 2, "width", "100%", "display", "inline-block", "position", "relative", "text-align", "left", "background", "#fff", "color", "#ddd", "border-radius", "12px", "margin-top", "10px"], ["matInput", "", "required", "", "placeholder", "Placeholder", "ngModel", "", "name", "location", 2, "color", "black"], ["matSuffix", ""]],
        template: function WeatherAppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function WeatherAppComponent_Template_form_ngSubmit_48_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);

              var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](49);

              return ctx.locationSubmitted(_r0);
            });
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("", ctx.temp, "\xB0C");
